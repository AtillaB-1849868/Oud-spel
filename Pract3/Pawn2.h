...
public:
	...
	bool checkMove(Type typeEnd, Color colorEnd, int rowStart, int colStart, int rowEnd, int colEnd, const Piece* board[8][8]) const override; //check Pawn move validity  
private:
	//int m_pawnNum;
	//Color m_color;
	bool m_hasMadeMove;
